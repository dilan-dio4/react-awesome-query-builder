...
var TimeWidget = /*#__PURE__*/function (_PureComponent) {
  ...
  function TimeWidget(props) {
    ...
    _this.handleChange = function (_value) {
      ...
      if (_value === null) setValue(_value.hour() * 60 + _value.minute());
    };

    var _valueFormat = props.valueFormat,
        value = props.value,
        _setValue = props.setValue;
    var mValue = value ? _dayjs["default"].utc(value, _valueFormat) : null;
  ...
  _createClass(TimeWidget, [{
    ...
    value: function render() {
      ...
      var timeValue = null;
      if (value !== null) timeValue = typeof value === 'number' ? _dayjs["default"].utc().startOf('day').minute(value) : _dayjs["default"].utc(value, valueFormat);
